                                ...
                                <div id="myCarousel" class="carousel slide" data-ride="carousel">
                                    ...
                                    <div class="carousel-inner">
                                        ...
                                        <div class="item active sliderimage">
                                            <div class="banner-thumb">
                                                <a href="#">
                                                    ...
                                                    <img class="img-responsive sliderimage" src="<%= Page.ResolveUrl("~")%>SliderImage/1.jpg" alt="Chicago" />
                                                </a>
                                            </div>
                                        ...
                                        <div class="item sliderimage">
                                            ...
                                            <div class="banner-thumb">
                                                <a href="#">
                                                    <img class="img-responsive sliderimage" src="<%= Page.ResolveUrl("~")%>SliderImage/2.jpg" alt="New york">
                                                </a>
                                            </div>
                                            <div class="banner-info white bg-color animated" data-animated="slideInUp">
                                                <h2 class="animated" data-animated="slideInLeft">
                                        ...
                                        <div class="item sliderimage">
                                            <div class="banner-thumb">
                                                <a href="#">
                                                    <img class="img-responsive sliderimage" src="<%= Page.ResolveUrl("~")%>SliderImage/3.jpg" alt="Chicago" />
                                                </a>
                                            </div>
                                            <div class="banner-info white bg-color animated" data-animated="slideInUp">
                                                <h2 class="animated" data-animated="slideInLeft">
                                        ...
                                        <div class="item sliderimage">
                                            <div class="banner-thumb">
                                                <a href="#">
                                                    ...
                                                    <img class="img-responsive sliderimage" src="<%= Page.ResolveUrl("~")%>SliderImage/4.jpg" alt="Chicago" />
                                                </a>
                                            </div>
                                            <div class="banner-info white bg-color animated" data-animated="slideInUp">
                                                <h2 class="animated" data-animated="slideInLeft">
                                        ...
                                        <div class="item sliderimage">
                                            <div class="banner-thumb">
                                                <a href="#">
                                                    <img class="img-responsive sliderimage" src="<%= Page.ResolveUrl("~")%>SliderImage/5.jpg" alt="New york" />
                                                </a>
                                            </div>
                                            <div class="banner-info white bg-color animated" data-animated="slideInUp">
                                                <h2 class="animated" data-animated="slideInLeft">
                                    ...
                                    <asp:Repeater ID="rptrHotnewarrivalProducts" OnItemDataBound="rptrMain_ItemDataBound1" runat="server">
                                        <ItemTemplate>
                                            <div class="item-product">
                                                <div class="product-thumb">
                                                    <a href='<%= Page.ResolveUrl("~")%><%# String.Concat("Pages/ProductDetails.aspx?PID=", Eval("PID").ToString()) %>' class="product-thumb-link">
                                                        <img height="150" width="300" src="<%= Page.ResolveUrl("~")%>ProductImage/<%#Eval("PID") %>/<%#Eval("Name")%><%#Eval("Extention")%>" alt="<%#Eval("Name")%>" />
                                                    </a>
                                                    <a href='<%# String.Concat("../../Pages/quickview.aspx?PID=", Eval("PID").ToString()) %>' class="quickview-link plus fancybox.iframe">quick view</a>

                                                </div>
                                                <div class="product-info">
                                                    <h3 class="product-title"><a href='<%= Page.ResolveUrl("~")%><%# String.Concat("Pages/ProductDetails.aspx?PID=", Eval("PID").ToString()) %>' class="product-thumb-link"><%# Eval("PName") %></a></h3>
                            ...
                            <div class="banner-box banner-box12">
                                <a href="#" class="link-banner-box">
                                    ...
                                    <asp:Repeater ID="rptrfoodcupboardimage" runat="server">
                                        <ItemTemplate>
                                            <img src="<%= Page.ResolveUrl("~")%>CategoryImage/<%#Eval("CatID") %>/<%#Eval("Name")%><%#Eval("Extention")%>" width="580" height="300" alt="<%#Eval("Name")%>" />
                                            ...
                                            <div class="col-lg-12 col-md-6 col-sm-6 col-xs-6">
                                                <div class="banner-zoom banner-zoom12">
                                                    <a href="#" class="thumb-zoom">
                                                        ...
                                                        <img src="<%= Page.ResolveUrl("~")%>CategoryImage/<%#Eval("CatID") %>/<%#Eval("Name")%><%#Eval("Extention")%>" alt="<%#Eval("Name")%>" />
                                                    </a>
                                                </div>
                                            </div>
            ...
            <div class="container">
                <div class="topcat-thismonth">
                    ...
                    <section class="gallery-block gallery-front">
                        <%--  <div class="container">--%>
                        <div class="row">
                            <a href="<%= Page.ResolveUrl("~")%>Pages/OurServices/IndianRestaurent.aspx" data-lightbox="example-1">
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="gallery-image">
                                        <img width="370" height="235" src="<%= Page.ResolveUrl("~")%>images/Ourservices/work1.jpg" />
                            ...
                            <a href="<%= Page.ResolveUrl("~")%>Pages/OurServices/Hotels.aspx" data-lightbox="example-1">
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="gallery-image">
                                    <img width="370" height="235" src="<%= Page.ResolveUrl("~")%>images/Ourservices/work3.png" />
                            ...
                            <a href="<%= Page.ResolveUrl("~")%>Pages/OurServices/FriedChickenAndChips.aspx" data-lightbox="example-1">
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="gallery-image">
                                    <img width="370" height="235" src="<%= Page.ResolveUrl("~")%>images/Ourservices/work4.png" />
                            ...
                            <a href="<%= Page.ResolveUrl("~")%>Pages/OurServices/FishAndChips.aspx" data-lightbox="example-1">
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="gallery-image">
                                    <img width="370" height="235" src="<%= Page.ResolveUrl("~")%>images/Ourservices/work5.jpg" />
                            ...
                            <a href="<%= Page.ResolveUrl("~")%>Pages/OurServices/CoffeeShop.aspx" data-lightbox="example-1">
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="gallery-image">
                                    <img width="370" height="235" src="<%= Page.ResolveUrl("~")%>images/Ourservices/work6.jpg" />
                            ...
                            <a href="<%= Page.ResolveUrl("~")%>Pages/OurServices/School.aspx" data-lightbox="example-1">
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="gallery-image">
                                    <img width="370" height="235" src="<%= Page.ResolveUrl("~")%>images/Ourservices/work8.jpg" />
