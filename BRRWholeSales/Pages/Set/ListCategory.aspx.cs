...
public partial class Pages_Set_ListCategory : System.Web.UI.Page
{
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            bool deletefromCAtdImage = mydal.deletefromCatdImage(lblid.Text);
            getCategory();
        }
        catch (Exception ex)
        {
    ...
    protected void gv_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        try
        {
            ...
            if (fu.HasFile)
            {
                string SavePath = Server.MapPath("~/CategoryImage/") + PID;
                ...
                bool updatephoto = mydal.updateCategoryphoto(PID, Pname, Extention, lblPIMGID);
            }
