<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminActivity.master" AutoEventWireup="true" CodeFile="ListSubCategory.aspx.cs" Inherits="Pages_Set_ListSubCategory" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    ...
    <div class="row">
        <div class="col-md-5">
            <asp:Button ID="addbtn" runat="server" Text="Add New" PostBackUrl="AddSubCategory.aspx"></asp:Button>
        </div>
