	...
	if($('.range-filter').length>0){
		$( ".range-filter #slider-range" ).slider({
			...
			slide: function( event, ui ) {
			    $("#amount").html("<span id='number1' class='number'>" + ui.values[0] + "</span>" + "<span class='separate'> - </span>" + "<span id='number2' class='number'>" + ui.values[1] + "</span>");

			    var a = document.getElementById("number1").innerHTML;
			    var b = document.getElementById("number2").innerHTML;
			    document.getElementById("lvlnumber1").innerHTML = a;
			    document.getElementById("lvlnumber2").innerHTML = b;
			    document.getElementById('ContentPlaceHolder1_txtnumber1').value = a;
			    document.getElementById('ContentPlaceHolder1_txtnumber2').value = b;
			}

		});
		
		$(".range-filter #amount").html("<span id='number1' class='number'>" + $("#slider-range").slider("values", 0) + "</span>" + " <span class='separate'> - </span> " + "<span id='number2' class='number'>" + $("#slider-range").slider("values", 1) + "</span>");
		var a = document.getElementById("number1").innerHTML;
		var b = document.getElementById("number2").innerHTML;
		document.getElementById("lvlnumber1").innerHTML =a;
		document.getElementById("lvlnumber2").innerHTML = b;
